...
namespace FDI {
    ...
    bool isLowerTooth(IdType id) noexcept;

    [[nodiscard("Make sure to handle return value")]]
    bool isUpperTooth(IdType id) noexcept;

    [[nodiscard("Make sure to handle return value")]]
    bool isLeftSideTooth(IdType id) noexcept;

    [[nodiscard("Make sure to handle return value")]]
    bool isRightSideTooth(IdType id) noexcept;
